...
## Introduction
This project aims to aid in the efficient delivery route and distributions for Western Governors University Parcel Service(WGUPS). 
A fictional delivery service provided by Western Governors University (WGU).
...
For this project I have elected to use a hash table for package data management and Dijkstra's algorithm for the route implementation.