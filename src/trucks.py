...
truck_1 = Truck(0, [1, 13, 14, 15, 16, 20, 29, 30, 31, 34, 37, 40], [], datetime.timedelta(hours=8), 0,
                datetime.timedelta(hours=8))

truck_2 = Truck(1, [3, 6, 12, 17, 18, 19, 21, 22, 23, 24, 26, 27, 35, 36, 38, 39], [],
                datetime.timedelta(hours=10, minutes=30), 0, datetime.timedelta(hours=8))

truck_3 = Truck(2, [2, 4, 5, 6, 7, 8, 9, 10, 11, 25, 28, 32, 33], [], datetime.timedelta(hours=9, minutes=5), 0,
                datetime.timedelta(hours=8))
